...
public class HOC_Resend {
	public WebDriver driver;
	public static List<String> jsondata;
	public static List<String> dbvalue;
final static Logger logger = Logger.getLogger(HOC_Resend.class);
...
String browser = System.getProperty("propertyName");
	...
	public void  before() throws IOException, InterruptedException {
		...
		jsondata=CredentialJson.returnCredential(3); // return first block from json (country DE)
	...
	public void test7App() throws InterruptedException {		
		...
		comment.add_comment("Comment resent by HOC to CFO");
