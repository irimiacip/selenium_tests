...
public class CFO_sendBack {
	public WebDriver driver;
	public static List<String> jsondata;
	public static List<String> dbvalue;
final static Logger logger = Logger.getLogger(CFO_sendBack.class);
...
String browser = System.getProperty("propertyName");
	...
	public void  before() throws IOException, InterruptedException {
		...
		jsondata=CredentialJson.returnCredential(4); // return second block from json (country DE)
	...
	public void test7App() throws InterruptedException {		
		...
		comment.add_comment("Comment sent back by CFO to HOC");
	...
	public void test8App() throws IOException, InterruptedException {   
		...
		Inbox inbox = new Inbox(driver);
		inbox.select_sendLevel("HOC");
		atachement.send_back();
	}
	@AfterClass
