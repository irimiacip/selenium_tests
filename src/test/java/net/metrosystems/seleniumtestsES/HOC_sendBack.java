...
public class HOC_sendBack {
	public WebDriver driver;
	public static List<String> jsondata;
	public static List<String> dbvalue;
final static Logger logger = Logger.getLogger(HOC_sendBack.class);
...
String browser = System.getProperty("propertyName");
	...
	public void  before() throws IOException, InterruptedException {
		...
		jsondata=CredentialJson.returnCredential(3); // return second block from json (country DE)
	...
	public void test7App() throws InterruptedException {		
		...
		comment.add_comment("Comment sent back by HOC to CM");
